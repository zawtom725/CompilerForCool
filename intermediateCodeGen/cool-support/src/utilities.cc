...
char *cool_token_to_string(int tok) {
  ...
  case (NEW):
    ...
    break;
  case (STR_CONST):
    return ((char *)"STR_CONST");
    break;
  case (INT_CONST):
    return ((char *)"INT_CONST");
    break;
  case (BOOL_CONST):
    return ((char *)"BOOL_CONST");
    break;
  case (TYPEID):
    return ((char *)"TYPEID");
    break;
  case (OBJECTID):
    return ((char *)"OBJECTID");
    break;
  case (ERROR):
    return ((char *)"ERROR");
    break;
...
void dump_cool_token(ostream &out, int lineno, int token,
                     YYSTYPE yylval __attribute__((unused))) {
