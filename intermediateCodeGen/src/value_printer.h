 ...
 * code generator in MP3. For a full list of LLVM instructions, visit
...
class ValuePrinter {
private:
  void bin_inst(ostream &o, string inst_name, operand op1, operand op2,
                operand result);
  ...
  void check_ostream(ostream &supplied) {
...
public:
  ...
  void init_struct_constant(operand constant, vector<op_type> field_types,
                            vector<const_value> init_values);
  ...
  void getelementptr(ostream &o, operand op1, operand op2, operand op3,
                     operand result);
  void getelementptr(ostream &o, operand op1, operand op2, operand op3,
                     operand op4, operand result);
  void getelementptr(ostream &o, operand op1, operand op2, operand op3,
                     operand op4, operand op5, operand result);
  ...
  operand getelementptr(operand op1, operand op2, operand op3,
                        op_type result_type);
  operand getelementptr(operand op1, operand op2, operand op3, operand op4,
                        op_type result_type);
  operand getelementptr(operand op1, operand op2, operand op3, operand op4,
                        operand op5, op_type result_type);
  ...
  /* Other operations */
  void select(ostream &o, operand op1, operand op2, operand op3,
              operand result);
  ...
  operand call(vector<op_type> arg_types, op_type result_type, string fn_name,
