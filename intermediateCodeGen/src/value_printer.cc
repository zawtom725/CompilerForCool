...
static void embed_getelementptr(ostream &o, operand op1, operand op2,
                                operand op3);
 ...
 */
void ValuePrinter::define(ostream &o, op_type ret_type, string name,
                          vector<operand> args) {
  check_ostream(o);
 ...
 */
void ValuePrinter::declare(ostream &o, op_type ret_type, string name,
                           vector<op_type> args) {
  check_ostream(o);
...
void ValuePrinter::declare(op_type ret_type, string name,
                           vector<op_type> args) {
 ...
 * 	}
 */
void ValuePrinter::type_define(ostream &o, string class_name,
                               vector<op_type> attributes) {
  check_ostream(o);
  o << "%" << class_name << " = type {\n\t";
...
void ValuePrinter::type_alias_define(ostream &o, string alias_name,
                                     op_type type) {
  check_ostream(o);
 ...
 */
void ValuePrinter::bin_inst(ostream &o, string inst_name, operand op1,
...
void ValuePrinter::xor_in(ostream &o, operand op1, operand op2,
                          operand result) {
 ...
 * you'll only need this one in MP3.
 */

void ValuePrinter::getelementptr(ostream &o, operand op1, operand op2,
...
operand ValuePrinter::getelementptr(operand op1, operand op2, operand op3,
                                    op_type result_type) {
...
operand ValuePrinter::getelementptr(operand op1, operand op2,
                                    op_type result_type) {
  operand result = make_fresh_operand(result_type);
 ...
 * number of operands but you'll only need this one in MP3.
 */
void ValuePrinter::getelementptr(ostream &o, operand op1, operand op2,
...
void ValuePrinter::getelementptr(ostream &o, vector<operand> op,
                                 operand result) {
  check_ostream(o);
  o << "\t";
  if (result.get_type().get_id() != VOID)
 ...
 * op3_name
 */
void ValuePrinter::select(ostream &o, operand op1, operand op2, operand op3,
                          operand result) {
  check_ostream(o);
 ...
 */
void ValuePrinter::branch_cond(ostream &o, operand op, label label_true,
                               label label_false) {
  check_ostream(o);
 ...
 */
void ValuePrinter::icmp(ostream &o, icmp_val v, operand op1, operand op2,
                        operand result) {
  check_ostream(o);
...
void ValuePrinter::call(ostream &o, vector<op_type> arg_types, string fn_name,
                        bool is_global, vector<operand> args,
                        operand result_op) {
  check_ostream(o);
  o << "\t";
 ...
 */
void ValuePrinter::bitcast(ostream &o, operand op, op_type new_type,
                           operand result) {
  check_ostream(o);
 ...
 */
void ValuePrinter::ptrtoint(ostream &o, operand op, op_type new_type,
                            operand result) {
  check_ostream(o);
