 ...
 * MP3. You can freely expand it as you like but you might need to modify
...
public:
  ...
  vector<op_type> get_arg_types(){ return args; }
};
...
public:
  ...
  global_value(op_type t, string n) {
    type = t;
    name = "@" + n;
  }
